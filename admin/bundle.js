...
module.exports = /*#__PURE__*/function () {
  ...
  _createClass(Editor, [{
    ...
    value: function onTextEdit(element) {
      ...
      DOMHelper.virtualDom.body.querySelector("[nodeid = \"".concat(id, "\"]")).innerHTML = element.innerHTML;
    }
  }, {
    key: "save",
    value: function save() {
      var newDom = DOMHelper.virtualDom.cloneNode(DOMHelper.virtualDom);
